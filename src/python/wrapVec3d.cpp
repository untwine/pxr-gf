...
static double _SequenceGetItem(PyObject *seq, Py_ssize_t i) {
    ...
    return extract<double>(pxr::boost::python::object(h));
}

static bool _SequenceCheckItem(PyObject *seq, Py_ssize_t i) {
    pxr::boost::python::handle<> h(PySequence_GetItem(seq, i));
    extract<double> e((pxr::boost::python::object(h)));
    return e.check();
}
    ...
    FromPythonTuple() {
        converter::registry::
            push_back(&_convertible, &_construct,
                      pxr::boost::python::type_id<GfVec3d>());
    }
...
{
    static pxr::boost::python::tuple getinitargs(const GfVec3d &v) {
