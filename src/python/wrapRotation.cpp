                    ...
                    const object & swShiftIn)
{
    double angle[4] = {
        thetaTwHint.ptr() != Py_None ? 
            pxr::boost::python::extract<double>(thetaTwHint) : 0.0,
        thetaFBHint.ptr() != Py_None ? 
            pxr::boost::python::extract<double>(thetaFBHint) : 0.0,
        thetaLRHint.ptr() != Py_None ? 
            pxr::boost::python::extract<double>(thetaLRHint) : 0.0,
        thetaSwHint.ptr() != Py_None ? 
            pxr::boost::python::extract<double>(thetaSwHint) : 0.0
        };
    double swShift = swShiftIn.ptr() != Py_None ? 
        pxr::boost::python::extract<double>(swShiftIn) : 0.0;
    ...
    const object &thetaSw)
{
    double angle[4] = {
        thetaTw.ptr() != Py_None ?
            pxr::boost::python::extract<double>(thetaTw) : 0.0,
        thetaFB.ptr() != Py_None ?
            pxr::boost::python::extract<double>(thetaFB) : 0.0,
        thetaLR.ptr() != Py_None ?
            pxr::boost::python::extract<double>(thetaLR) : 0.0,
        thetaSw.ptr() != Py_None ?
            pxr::boost::python::extract<double>(thetaSw) : 0.0
        };
