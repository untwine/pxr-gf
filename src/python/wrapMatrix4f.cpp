...
static tuple FactorWithEpsilon(GfMatrix4f &self, double eps) {
    ...
    return pxr::boost::python::make_tuple(result, r, s, u, t, p);
}    
...
struct GfMatrix4f_Pickle_Suite : pxr::boost::python::pickle_suite
{
    static pxr::boost::python::tuple getinitargs(const GfMatrix4f &m)
    {
