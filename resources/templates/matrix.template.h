...
//
#}
#ifndef PXR_BASE_GF_{{ UPPER(MAT)[2:] }}_H
#define PXR_BASE_GF_{{ UPPER(MAT)[2:] }}_H
...
#include <pxr/gf/declare.h>
#include <pxr/gf/matrixData.h>
#include <pxr/gf/vec{{ SUFFIX }}.h>
...
#endif // PXR_BASE_GF_{{ UPPER(MAT)[2:] }}_H
