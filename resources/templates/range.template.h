...
#ifndef PXR_GF_{{ UPPER(RNG)[2:] }}_H
#define PXR_GF_{{ UPPER(RNG)[2:] }}_H
...
{% if DIM > 1 %}
#include "pxr/gf/vec{{ DIM }}d.h"
#include "pxr/gf/vec{{ DIM }}f.h"
{% endif %}
...
#include "pxr/gf/range{{ DIM }}{{ S[0] }}.h"
GF_NAMESPACE_OPEN_SCOPE
{% endfor %}
